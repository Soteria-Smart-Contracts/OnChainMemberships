...
contract LiquidSubscription {
    ...
    mapping(MembershipLengths => uint256) public DiscountSteps;
    ...
    function PurchaseSubscription(MembershipTypes _MembershipType, MembershipLengths _MembershipLength) public payable{
    ...
    //allow manager to change the price, name, bnefit of a membership type
